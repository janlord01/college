        ...
        <section class="flex flex-col break-words bg-white sm:border-1 sm:rounded-md sm:shadow-sm sm:shadow-lg content-header">
            ...
            <header class="font-semibold bg-gray-200 text-gray-700  py-5 px-6 sm:py-6 sm:px-8 sm:rounded-t-md relative ">
                ...
                <form class="" method="GET"
                    action="{{ route('temp.student.search') }}" class="search_form">
                    <input id="search" type="text" class="bg-gray-100  text-gray-700 font-bold mb-0 h-9 border border-gray-500 rounded absolute right-20 mr-2 bottom-3 form-input @error('search')  border-red-500 @enderror search_input"
                    ...
                    @enderror
                    <button type="submit" class="bg-gray-300 hover:bg-gray-400 text-gray-700 font-bold py-2 px-3 border border-gray-500 rounded absolute xs:right-10  right-8 mr-2 bottom-3 search_btn"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
                            ...
                            @foreach ($students as $student)
                                <tr class="border border-grey-500 md:border-none block md:table-row">
                                    ...
                                    <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell">
                                        ...
                                        <a href="{{ route('temp.student.add_payable', $student->id) }}" alt="Add">
                                            <button class="text-white hover:text-white font-bold p-1 rounded bg-green-500 hover:bg-green-700">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cash-stack m-1 inline" viewBox="0 0 16 16">
