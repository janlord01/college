                    ...
                    <div class="grid grid-cols-3 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 xs_div">
                        <div class="flex flex-wrap pr-2">
                            ...
                            <input id="name" type="text" class="form-input w-full @error('name')  border-red-500 @enderror"
                                name="name" value="{{ $course->course_name }}"  autocomplete="name" placeholder="Bachelor of Science in Information Technology" autofocus required>
                        ...
                        <div class="flex flex-wrap pr-2">
                            ...
                            <input id="code" type="text" class="form-input w-full @error('code')  border-red-500 @enderror"
                                name="code" value="{{ $course->course_code }}"  autocomplete="code" placeholder="BSIT" autofocus required>
                        ...
                        <div class="flex flex-wrap pr-2">
                            ...
                            <input id="description" type="text" class="form-input w-full @error('description')  border-red-500 @enderror"
                                name="description" value="{{ $course->course_description }}"  autocomplete="description" placeholder="...." autofocus required>
